...
INSERT INTO RECIPE (RECIPE_NAME, CATEGORY, INGREDIENTS, INSTRUCTIONS, CREATOR_ID) VALUES ('Boiled Water', 'Drink', 'H20, heat', 'Heat the H20 till bubbles. Stop heating.', (SELECT CHEF_ID FROM CHEF WHERE FIRST_NAME = 'Pedro'));

INSERT INTO MEAL_PLAN (RECIPE_ID, CHEF_ID, MEAL_PLAN_DATE) VALUES ((SELECT RECIPE_ID FROM RECIPE WHERE RECIPE_NAME = 'Empanadas'), (SELECT CHEF_ID FROM CHEF WHERE FIRST_NAME = 'Pedro'), '2022-10-20');
INSERT INTO MEAL_PLAN (RECIPE_ID, CHEF_ID, MEAL_PLAN_DATE) VALUES ((SELECT RECIPE_ID FROM RECIPE WHERE RECIPE_NAME = 'Quesadillas'), (SELECT CHEF_ID FROM CHEF WHERE FIRST_NAME = 'Pedro'), '2022-10-21');

INSERT INTO FAVORITE (RECIPE_ID, CHEF_ID) VALUES ((SELECT RECIPE_ID FROM RECIPE WHERE RECIPE_NAME = 'Boiled Water'), (SELECT CHEF_ID FROM CHEF WHERE FIRST_NAME = 'Pedro'));
